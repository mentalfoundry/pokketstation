...
Currently attempting to complete the ps1 SIO so that the core can talk to ps1 emulators - this could take a while but it's also the last big gap in the code - whoah we are halfway there~~~ whoah! living on a prayer~~.
