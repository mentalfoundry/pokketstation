...
int main(int argc, char *argv[]) {
    ...
    /* TODO: load a BIOS dump and an app from ux0:data/pokketstation/ after
       a file selection screen is available.
       At this time, this code tests only the render loop. */
    psemu_reset(ps);
